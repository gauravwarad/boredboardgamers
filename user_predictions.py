...
class UserPredictions:
    ...
    def generate_predictions(self, ):
        ...
        try:
            ...
            top_20_rows = df_predictions.limit(20)
            #
            # # Convert the top 20 rows to JSON
            # self.predictions = [row.toJSON() for row in top_20_rows]
            self.predictions = df_predictions.collect()
            self.predictions = top_20_rows.toJSON().collect()
